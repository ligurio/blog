...
технология находит применение и в других областях. Поэтому в разработке успели
...
представил [P.Haul](https://criu.org/P.Haul). В чем его особенности и назначение?
...
[devel@openvz.org](https://lists.openvz.org/pipermail/devel/). В репозитории ядра
