...
получившиюся систему через набор тестов. Это очень полезно, сразу понять -
...
Работает всё при помощи Buildbot, и собственной тулзы под названием Testman
...
то это перепесывание должно происходить вначале в ветке (бранче),
