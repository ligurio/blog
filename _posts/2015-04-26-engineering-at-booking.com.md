...
поставил под этим свою подпись фактом коммита, и выразил готовность к тому, что
...
* Быть более консервативным.  * Следить за всем[c], даже не связанным с
выкаченным кодом.  * Если возникают проблемы, сначала откатываешь, потом
разбираешься[d].
...
конвертировать пользователей? отодвигают вопросы почему перл? на задний план.
