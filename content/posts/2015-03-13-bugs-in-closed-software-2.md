...
[Apple Radar](https://siliconrus.com/2015/02/apple-test/) -
...
Проект [OpenRadar](https://openradar.me) - это попытка собрать в одном месте все ошибки,
...
Проект был анонсирован на [Ars Technica](https://arstechnica.com/news/open-radar-using-social-networking-to-squash-apple-bugs.ars) в 2008 году и активен до сих пор. В Open Radar есть строгое правило
...
и работает на платформе Google Apps. Багтрекер имеет [API](https://openradar.appspot.com/api/radars),
...
<!--
старый вариант багтрекера https://open-radar.lighthouseapp.com/
-->
...
- <https://habrahabr.ru/post/63430/>
- <http://software-testing.ru/community/blog/panbugon/>
- <https://habrahabr.ru/post/81390/#comment_3815233>
...
Отличный пример подала компания Билайн - они [сделали](https://habrahabr.ru/company/beeline/blog/250387/)
свободно доступной карту, на которой отмечены места с плохим покрытием связи.

## Геоинформационный портал «Наш город»

Портал Наш город создан для <https://gorod.mos.ru/?show=problem>
-->
