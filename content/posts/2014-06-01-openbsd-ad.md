...
[OpenBSD](https://www.openbsd.org) я пользовался около восьми лет как основной
...
базовую систему разработчиков не удовлетворила подробность документации для [nginx.conf](https://www.openbsd.org/cgi-bin/man.cgi?query=nginx.conf&sektion=0&manpath=OpenBSD+Current&arch=amd64&format=html) и они man page написали сами.
...
Для управления RAID массивами в OpenBSD есть [bioctl(8)](https://www.openbsd.org/cgi-bin/man.cgi?query=bioctl&apropos=0&sektion=0&manpath=OpenBSD+Current&arch=i386&format=html), в Linux же для каждого вендора своя утилита
...
за все компоненты: ядро, юзерспейс, Xorg ([Xenocara](https://xenocara.org)).
...
Теперь существуют [три реализации ACPI парсера](https://www.openbsd.org/papers/zzz-presentation.pdf):
...
и не быть никому ничем обязанным. [Пожертвования](https://www.openbsd.org/donations.html) остаются на ваше усмотрение.
...
* [Пользователи OpenBSD](https://www.openbsd.org/users.html)
* [Пользователи FreeBSD](https://www.freebsd.org/commercial/)
