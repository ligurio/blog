...
Перебрав самые известные приложения ([GnuCash](https://www.gnucash.org),
[kmymoney](http://kmymoney2.sourceforge.net/),
[aqbanking](https://www.aquamaniac.de/sites/aqbanking/), [grisbi](http://www.grisbi.org),
[cbb](https://gna.org/projects/cbb/), ledger) мне по тем или иным причинами ни одно не понравилось.
...
можно почерпнуть в блоге <a href="https://city-rat.livejournal.com/tag/бухучет">city-rat.livejournal.com</a>,
...
- импорт из формата CSV, экспорт в формат [OFX](https://en.wikipedia.org/wiki/Open_Financial_Exchange)
...
загружая данные с сайта [Центрального банка Российской Федерации](https://cbr.ru).
...
с помощью [cron(8)](https://www.openbsd.org/cgi-bin/man.cgi/OpenBSD-current/man8/cron.8?query=cron&sec=8).
...
самых крупных игроков. Вот [некоторые](https://wiki.gnucash.org/wiki/OFX_Direct_Connect_Bank_Settings) их них.
<!--
https://habrahabr.ru/post/129721/
-->
